...
class SensorServiceStub(object):
    """gRPC service equivalent to Cap'n Proto SensorService
    """
    ...
    def __init__(self, channel):
        ...
        self.SendData = channel.unary_unary(
                '/sensor.SensorService/SendData',
                request_serializer=sensor__pb2.SensorDataBatch.SerializeToString,
...
def add_SensorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendData': grpc.unary_unary_rpc_method_handler(
                    servicer.SendData,
                    request_deserializer=sensor__pb2.SensorDataBatch.FromString,
...
class SensorService(object):
    ...
    def SendData(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/sensor.SensorService/SendData',
            sensor__pb2.SensorDataBatch.SerializeToString,
